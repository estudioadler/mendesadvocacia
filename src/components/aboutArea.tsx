...
export const AboutArea = () => {
  return (
    <section id="sobre" className="container mx-auto px-6 md:px-8 rounded-b-3xl bg-palette-mist">
      <div className="flex flex-col gap-8 py-20"> 
        <TitleSection title="Expertise comprovada em Direito do Trabalho." tagTitle="Sobre nós"/>
        <div className="w-full">
          <p className="text-palette-deepGreen leading-relaxed text-lg lg:text-xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl">
            A <span className="font-medium text-palette-deepGreen">Mendes Advocacia</span> é um escritório especializado
