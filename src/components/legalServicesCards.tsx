...
export default function LegalServicesCards() {
  const services = [
    ...
    },
    {
      ...
      icon: <Truck className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      title: "Danos morais",
      description:
      ...
      icon: <AlertTriangle className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      title: "Horas extras",
      description:
    ...
    },
    {
      ...
      icon: <FileText className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      title: "Insalubridade",
      description:
        "Assessoramos na obtenção de adicionais de insalubridade para trabalhadores que operam em condições nocivas à saúde.",
      icon: <Thermometer className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      ...
      icon: <ShieldAlert className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      ...
      icon: <FileSignature className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      ...
      icon: <UserX className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      ...
      icon: <Scale className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      ...
      icon: <Flame className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
    {
      ...
      icon: <Users className="h-8 w-8 text-primary" strokeWidth={1} />,
    },
  ]

  return (
    <section id="servicos" className="container-x mx-auto py-20 flex flex-col gap-12 border-b border-palette-secondary">
      <TitleSection title="Como podemos te ajudar" tagTitle="Serviços" />
